...
INSERT INTO test_db.product (id, name, description, image, price) VALUES (1, 'PHP Elephant', 'PHP elephants can now be bought in Ukraine! HR, executives, wives and friends of IT workers! Now you do not have to bother with the gift, on any occasion for its developers, coders and other carriers of the proud title of IT :)', '/app/images/one.jpg', 4000);
INSERT INTO test_db.product (id, name, description, image, price) VALUES (2, 'PHP Elephant', 'PHP elephants can now be bought in Ukraine! HR, executives, wives and friends of IT workers! Now you do not have to bother with the gift, on any occasion for its developers, coders and other carriers of the proud title of IT :)', '/app/images/two.jpg', 4533);
INSERT INTO test_db.product (id, name, description, image, price) VALUES (3, 'PHP Elephant', 'PHP elephants can now be bought in Ukraine! HR, executives, wives and friends of IT workers! Now you do not have to bother with the gift, on any occasion for its developers, coders and other carriers of the proud title of IT :)', '/app/images/three.jpg', 4599);
INSERT INTO test_db.product (id, name, description, image, price) VALUES (4, 'PHP Elephant', 'PHP elephants can now be bought in Ukraine! HR, executives, wives and friends of IT workers! Now you do not have to bother with the gift, on any occasion for its developers, coders and other carriers of the proud title of IT :)', '/app/images/four.jpg', 5555);
INSERT INTO test_db.product (id, name, description, image, price) VALUES (5, 'PHP Elephant', 'PHP elephants can now be bought in Ukraine! HR, executives, wives and friends of IT workers! Now you do not have to bother with the gift, on any occasion for its developers, coders and other carriers of the proud title of IT :)', '/app/images/five.jpg', 4123);
INSERT INTO test_db.product (id, name, description, image, price) VALUES (6, 'PHP Elephant', 'PHP elephants can now be bought in Ukraine! HR, executives, wives and friends of IT workers! Now you do not have to bother with the gift, on any occasion for its developers, coders and other carriers of the proud title of IT :)', '/app/images/six.jpg', 4799);
INSERT INTO test_db.product (id, name, description, image, price) VALUES (7, 'PHP Elephant', 'PHP elephants can now be bought in Ukraine! HR, executives, wives and friends of IT workers! Now you do not have to bother with the gift, on any occasion for its developers, coders and other carriers of the proud title of IT :)', '/app/images/seven.jpg', 4999);
INSERT INTO test_db.product (id, name, description, image, price) VALUES (8, 'Gopher pilot ', 'The mascot of the Go Golang programming language.
Gopher pilot- 6inches.
The toy is made of soft felt.
Toy filler-sintepon.
The gopher can stand on the table on its own, for this purpose we inserted a wire into the tail
The gopher is wearing a removable leather helmet.

The idea of creating a mascot belongs to Rene French (Illustrator from the United States)
It was only because of this that the image of our gopher-the felt gopher-appeared.', '/app/images/eight.jpg', 4999);
INSERT INTO test_db.product (id, name, description, image, price) VALUES (9, 'Gopher Superman', 'Gopher superhero
Go Gopher-toy made of felt.
Size -6 inche
Gopher in the costume of the heroes of movies and comics .
Gopher superman, order gopher superhero, Wonder women Gopher in costume R2D2,

The idea of creating a mascot belongs to Rene French (Illustrator from the United States).
It was only because of this that the image of our gopher-the felt gopher-appeared.', '/app/images/nine.jpg', 4999);
INSERT INTO test_db.product (id, name, description, image, price) VALUES (10, 'Gopher king', 'The talisman-king of the gophers.
The Go Gopher mascot is 6.3 inches.
Made of soft felt.

The gopher can stand on the table on its own, for this purpose we inserted a wire into the tail

The idea of creating a mascot belongs to Renee French (illustrator from the USA).
And only because of her image of Gopher our Gopher of felt was appeared.

Felt gopher requires careful care!
You can clean it with adhesive tape or brush roller,it will clean the felt from small coils and dust.', '/app/images/ten.jpg', 4999);
...
INSERT INTO test_db.version (id, version, description, used, created_at) VALUES (1, '0.0.1', 'Старт разработки', 1, '2021-02-27 20:24:32');
INSERT INTO test_db.version (id, version, description, used, created_at) VALUES (2, '0.0.2', 'Первая бета готова', 1, '2021-02-27 20:24:32');

INSERT INTO test_db.version_notification (chat_id, version_id, created_at) VALUES (1648012087, 1, '2021-02-27 20:25:23');
INSERT INTO test_db.version_notification (chat_id, version_id, created_at) VALUES (281861745, 2, '2021-02-27 20:25:56');
INSERT INTO test_db.version_notification (chat_id, version_id, created_at) VALUES (1648012087, 2, '2021-02-27 20:25:56');
